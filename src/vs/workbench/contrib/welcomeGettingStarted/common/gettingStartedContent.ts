...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		...
		content: {
			...
			steps: [
				{
					id: 'integrityAiSetup',
					title: localize('gettingStarted.integrityAi.title', "Use AI features with Integrity"),
					description: localize('gettingStarted.integrityAi.description.interpolated', "Integrity AI runs locally with Ollama by default. Pull recommended models, or add your own API keys for cloud fallback.\n{0}\n{1}", Button(localize('setupModels', "Setup Recommended Models"), 'command:integrity.ai.setupModels'), Button(localize('openIntegrityChat', "Open Integrity Chat"), 'command:integrity.ai.openChat')),
					media: {
						type: 'svg', altText: 'Integrity AI', path: 'multi-file-edits.svg'
					},
				},
				{
					id: 'pickColorTheme',
				...
				{
					id: 'videoTutorial',
					title: localize('gettingStarted.learnMore.title', "Learn more about Integrity"),
					description: localize('gettingStarted.learnMore.description.interpolated', "Read how Integrity's local-first AI layer works, including chat, completions, and optional BYOK cloud fallback.\n{0}", Button(localize('readReadme', "Read the README"), 'https://github.com/Riley94/integrity#readme')),
					media: { type: 'svg', altText: 'Integrity settings', path: 'learn.svg' },
				}
			]
		}
	},
		...
		content: {
			...
			steps: [
				...
				},
				{
					...
					when: 'workspacePlatform == \'webworker\'',
					media: {
						type: 'svg', altText: 'Integrity extension marketplace with featured language extensions', path: 'extensions-web.svg'
					},
				},
				{
			...
			steps: [
				{
					...
					completionEvents: ['onEvent:sync-enabled'],
					media: {
						type: 'svg', altText: 'Integrity Settings', path: 'settings.svg'
					},
				},
				{
					id: 'extensions',
					...
					when: 'workspacePlatform != \'webworker\'',
					media: {
						type: 'svg', altText: 'Integrity extension marketplace with featured language extensions', path: 'extensions.svg'
					},
				},
				{
					id: 'terminal',
